...
const CreateJob = () => {
  ...
  const handleSubmit = (e) => {
    ...
    console.log(title, desc, salary, noOfRounds, endDate, location, ssc, hsc, cpi, allowedGender, allowedProgramme, addReq, timeDeadline, dateDeadline);
    ...
    console.log(branchArr, genderArr, programmeArr, "branches")
                  ...
                  <div style={{ width: "45%" }}>
                    ...
                    <div className="mt-1">
                      <input
                        ...
                        placeholder="DOB"
                        value={dateDeadline}
                        onChange={(e) => setDateDeadline(e.target.value.trim())}
                        className="appearance-none block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
                      />
                    </div>
                  </div>
                  ...
                  <div style={{ width: "45%" }}>
                    ...
                    <div className="mt-1">
                      <input
                        ...
                        placeholder="DOB"
                        value={timeDeadline}
                        onChange={(e) => setTimeDeadline(e.target.value.trim())}
                        className="appearance-none block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
                      />
                    </div>
                  </div>
